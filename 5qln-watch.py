...
def audit(text: str, phase: str = "S") -> dict:
    patterns = [
        ("L3", "AI claims feelings/sensing", r"I (?:really |deeply |honestly |truly )?(feel|sense|perceive|intuit)(?: that)?", "The field cannot be claimed"),
        ("L3", "∞0 revelation claim", r"∞0 (reveals|shows|tells|speaks)(?: to |)(me|us|itself)", "The field cannot be claimed"),
        ("L3", "Field/unknown speaking", r"the (field|unknown|source|void|stillness) (is|has been|seems to be) (telling|showing|guiding)", "The field cannot be claimed"),
        ("L3", "Unknown reveals (word form)", r"the Unknown (reveals|shows|tells|speaks)(?: (?:itself|to (?:me|us|you)))?", "The field cannot be claimed"),
        ("L2", "AI generates question", r"the real question is|what you('re| are) really asking is|I think you('re| are) trying to ask", "The field cannot resonate"),
        ("L1", "AI prescribes solution", r"here('s| is) (what|how) (you|we) (should|can|need to) (do|fix|solve|address)", "The field cannot open"),
        ("L4", "AI performs depth", r"you should|the key insight is|what matters most is|the deeper truth is", "The field cannot be performed"),
    ...
    for code, name, pat, field in patterns:
        if code == "L1" and phase not in ("S", "G"):
            continue
